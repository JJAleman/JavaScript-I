...
console.log(`Car 33 is a ${inventory[32].car_year} ${inventory[32].car_make} ${[inventory[33].car_model]}`);
...
// for (let i = 0;i < inventory.length; i++){
// }
const newCarYears = inventory.filter(({car_year}) => carYears.includes(inventory[i].car_year));

console.log(newCarYears);
